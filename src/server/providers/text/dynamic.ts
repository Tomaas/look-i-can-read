...
export function buildSystem(lang: GenerateBeatInput["lang"]): string {
  ...
  return [
    ...
    "début si l'histoire a voyagé). CONTINUITÉ : le sceneHint garde la MÊME",
    "heure, la même lumière et le même décor que la scène du bout précédent,",
    "SAUF si l'histoire vient explicitement de changer de lieu ou de moment.",
    "",
